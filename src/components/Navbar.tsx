...
import { Bird, Home, LogIn, UserPlus, User, Settings, LogOut, Menu, X, Sun, Moon, Trophy, ListChecks } from 'lucide-react'
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <Link
              to="/"
              className={`flex items-center space-x-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${location.pathname === '/'
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden glass rounded-xl mt-2 mb-4 overflow-hidden shadow-xl border border-slate-200 dark:border-dark-border">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link
                to="/"
                className={`flex items-center space-x-2 px-3 py-3 rounded-lg text-sm font-medium transition-colors ${location.pathname === '/'
